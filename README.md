...
- Install [NVSE](https://github.com/xNVSE/NVSE/releases) or [FOSE](https://fose.silverlock.org) depending on your game.
...
- Targets Fallout 3 runtime 1.7.0.3 (Steam/GOG); requires [FOSE](https://fose.silverlock.org)
