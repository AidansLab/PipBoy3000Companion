  ...
  additemhealthpercent(id, cnt, cnd) {
    ...
    return (
      ['AID', 'AMMO', 'APPAREL', 'MISC', 'WEAPONS'].forEach((v) => {
        ...
        const inv = new InvFile(`INV/${NV ? 'NV' : 'F3'}/${v}.INV`, {
            idOrder: db.ids
          }),
          inx = inv.indexOf(id);
        if (inx > 0) {
      ...
      case 0:
        return {
          ...
          header: () => {
            ...
            return [
              ['LVL', USER.level],
              ['HP', `${Math.floor(USER.maxHP * USER.hp)}/${USER.maxHP}`],
        ...
        return {
          ...
          header: () => {
            ...
            return [
              ...
              [
                'HP',
                `${Math.floor(USER.maxHP * USER.hp)}/${USER.maxHP}`.padStart(
                  7,
                  ' '
                )
              ],
...
class InvFile {
  ...
  sort(da) {
    if (!this.buf) return;
    const r = new Float64Array(this.buf),
